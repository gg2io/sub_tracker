...
import { updateSubscription, createCategory, createPaymentMethod } from '../services/api';
import { X, Edit } from 'lucide-react';

export default function EditSubscriptionModal({ subscription, categories, paymentMethods, onClose, onUpdated }) {
